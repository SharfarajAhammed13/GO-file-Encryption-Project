...
import (
	...
	"github.com/SharfarajAhammed13/GO-file-Encrpytion-Project/filecrypt"
	"golang.org/x/term"
)
...
func main() {
	...
	case "decrypt":
		decryptHandle()
	default:
		fmt.Println("Run encrypt to encrypt, and decrypt to decrypt a file")
		os.Exit(1)
	}
